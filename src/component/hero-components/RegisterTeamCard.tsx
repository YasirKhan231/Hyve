...
const RegisterTeamCard = () => {
  return (
    <div className="bg-white p-8 rounded-xl shadow-lg max-w-md relative">
      ...
      <h3 className="text-lg font-medium mb-4">Register Your Team</h3>
      <p className="text-gray-600 text-base mb-6">
        Are you a team looking to showcase your skills and find exciting
        projects? Register your interest now!
      </p>
      <button className="w-full py-2.5 bg-[#F7A800] hover:bg-[#e69a00] text-white rounded-md flex items-center justify-center gap-2 transition-colors font-medium">
        <svg
          width="20"
          height="20"
          viewBox="0 0 24 24"
        ...
        <span>Register Team Interest</span>
      </button>
    </div>
  );
};
